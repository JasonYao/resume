...
{
\small % At normal size it moves the rest onto a second page, so either have all 5 at small, or 4 at normal size
\urlstyle{same}
...
\workplace{MediaMath}{Oct. 2017 – Present} \\
\position{Software Engineer II}{New York, NY}
...
\workplace{MediaMath}{Jul. 2017 – Oct. 2017 (3 months)} \\
\position{Software Engineer I}{New York, NY}
% \vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
...
\workplace{Ivy Tech Capital}{Jun. 2016 – Aug. 2016 (3 months)}\\
...
\workplace{Phi Kappa Sigma Delta Phi Chapter}{Jan. 2015 – May 2017}\\

...
SUMMARY_DATA = {
  ...
  "current_work_summary": {
    "job_title": "Tech Lead (Search Debug), Senior Software Engineer",
    "employer": "Google",
    ...
    "positions": [
      {
        ...
        "end_date": None,
        "descriptions": [
          "**Tech lead for team of 10 engineers** enhancing debugging capabilities on Google Search's next-generation LLM-powered platforms, increasing productivity for 5k+ MAU engineers",
          "Designed and led implementation on Google Search's next generation debugging platform, resulting in entirely new debugging capabilities",
          "Led cross-team overhaul for underlying Google-wide debug logging service, **driving down read-after-write latencies from 35s+ to <5s (an >85.7% decrease)**",
          "Upskilled/mentored team members to be excellent individual contributors, recognized through promotions for team members",
        ]
      },
      {
